...
map.on('load', () => {
  loadGeoJsonLayer('asrama_putra', 'assets/geojson/Asrama Putra.geojson', '#2a7fff');
  loadGeoJsonLayer('asrama_putri', 'assets/geojson/Asrama Putri.geojson', '#ff4d4d');
  loadGeoJsonLayer('bangunan_umum', 'assets/geojson/Bangunan Umum.geojson', '#868686');
});
